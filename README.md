...
| 🧩 | [Refinamento técnico](core/processo/2.refinamento-tecnico/README.md) | Arquitetura, riscos, backlog e pasta `tasks/` (EP/US/SC) |
| 💻 | [Desenvolvimento](core/processo/3.desenvolvimento/README.md) | Por IA: clone → branch → TDD → implementar → testar → PR → Pendente aprovação |
