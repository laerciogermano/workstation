...
| | Seção | Descrição |
|:--:|:------|:----------|
| ✅ | [**Tasks**](core/tasks/README.md) | Árvore de execução, Gantt e kanban Todo / Doing / Done |
...
| | Fase | Descrição |
|:--:|:-----|:----------|
| 🔍 | [Discovery](core/processo/1.discovery/README.md) | Stories → epics → scenarios → BDDs → protótipo → roadmap → tasks; depois o ciclo por estória |
