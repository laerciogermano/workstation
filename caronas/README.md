...
| **Vaga ociosa sem renda** | O motorista já faz o caminho e paga tudo sozinho. Os assentos vazios não rendem nada. Falta transformar essa vaga ociosa em **fonte de renda extra** no trajeto que de qualquer forma seria feito. |

As pessoas **já repetem o mesmo trajeto**, nos mesmos horários, nos mesmos dias. Muitas vezes **já tem alguém no próprio prédio** que faz o mesmo caminho — e os dois não se conhecem. O que falta é um jeito simples de **encontrar quem vai para o mesmo lugar** (a começar pelo vizinho do mesmo edifício), dividir o carro: o passageiro gasta menos e o motorista tem **renda extra**.

## Para quem

| Persona | Para quem | Necessidade |
|---------|-----------|-------------|
| **Motorista** | Quem tem carro e já faz o trajeto casa–trabalho | Oferecer vagas ociosas e ter uma **fonte de renda extra** no trajeto que já faria, com companhia previsível |
...
Conectar pessoas do **mesmo trajeto recorrente de trabalho** — e em especial quem **mora no mesmo prédio** — para que compartilhem caronas de ida e volta: **menos carros na rua**, **menos custo para quem participa** e **renda extra para o motorista**.

## Proposta de valor

O Caronas trata o deslocamento para o trabalho como uma **rotina compartilhada**, não como uma corrida avulsa. Quem já vai, leva quem já iria: o passageiro gasta menos; o motorista tem **renda extra** com as vagas que iriam vazias.
...
| Ter renda extra no trajeto que já faria | Tornar visível o retorno do motorista ao ocupar vagas ociosas |
...
3. **Renda extra no trajeto, não corrida profissional** — o motorista que já vai ganha uma fonte de renda extra ao ocupar vagas; o passageiro gasta menos do que ir sozinho. O app não é praça de motorista de aplicativo.
...
| **Custo e renda** | Estimar custo do passageiro e renda extra do motorista; registrar o combinado |
...
Uma ocorrência (ou série recorrente) em que um **motorista** leva um ou mais **passageiros** no trajeto combinado. Tem vagas, ponto de encontro, horário, custo para o passageiro e **renda extra** para o motorista.
...
### Custo e renda do trajeto

Valor de referência da viagem (combustível, pedágio e, se fizer sentido, estacionamento) combinado entre quem ocupou o carro: o **passageiro paga menos** do que ir sozinho; o motorista tem **renda extra** com as vagas que iriam vazias. Não é preço de corrida de aplicativo.
...
- O motorista tem **renda extra** no trajeto que já faria, ao ocupar vagas que já existiam.
...
| **Partilha** | Combinado de custo do passageiro e renda extra do motorista |
| **Renda extra** | Retorno do motorista ao ocupar vagas no trajeto que já faria — fonte de renda complementar, não tarifa de aplicativo |
| **Lucro** | Resultado financeiro positivo do motorista nessa renda extra |
...
- Partilha é estimativa e combinado entre pessoas: deixa explícito o custo do passageiro e a renda extra do motorista; o app não processa pagamento em v1.
