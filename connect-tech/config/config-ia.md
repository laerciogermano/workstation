# Configurações para a IA — Connect Tech
...
4. Repetir até chegar ao **último nó** da árvore (HTML da landing).
5. Não encerrar a tarefa com a esteira pela metade.
6. Artefatos ainda **a produzir** só entram na cascata quando o passo anterior for pedido ou criado — **HTML só depois da visão validada**.

### Referência Leany

Ao gerar HTML/copy: usar [leany.com.br](https://leany.com.br/) só como **estrutura e tom**; conteúdo e marca são Connect Tech / ConectMax. Proibido copiar textos ou assets da Leany.
...
└── docs/README.md
    └── site-structure.md
        └── index.html (landing v1)
```

| Ordem | Artefato | Próximo |
|-------|----------|---------|
| 0 | [`../README.md`](../README.md) (visão) | [`../docs/README.md`](../docs/README.md) |
| 1 | [`../docs/README.md`](../docs/README.md) | `../docs/site-structure.md` |
| 2 | `site-structure.md` | `../index.html` |
| 3 | `index.html` | *(fim da árvore v1)* |
