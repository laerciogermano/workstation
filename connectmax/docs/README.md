...
| Funcionalidades | [`functionalities.md`](functionalities.md) | Capacidades de cada seção e página em bullets | Feito |
...
→ Esteira de produto: [`functionalities.md`](functionalities.md) → `user-stories.md` (a produzir)
