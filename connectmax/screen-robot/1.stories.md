...
Compõe a hierarquia navegável da tela (estilo DOM).

**Primeiro** extrai **apenas textos**; **em seguida** extrai o restante (ícones, listas, imagens) e compõe a árvore raiz → filhos. Não depende de US-14..17 como pré-requisito obrigatório — essas US continuam como extrações especializadas opcionais/complementares.

### US-14 — Extrair ícones

Reconhece ícones na tela.

A partir de imagem/frame ou dump, detecta ícones com bounds e metadados. Extração especializada; a árvore DOM (US-13) já cobre ícones na fase “restante”.

### US-15 — Extrair textos

Extrai textos da tela via OCR.

A partir de imagem/frame, reconhece strings e posições (bounds). Extração especializada; a árvore DOM (US-13) já inicia pela fase de textos.

### US-16 — Extrair listas

Extrai listas com itens filhos.

Identifica nós de lista e seus itens na tela/dump, com hierarquia lista → filhos. Extração especializada; a árvore DOM (US-13) já cobre listas na fase “restante”.

### US-17 — Extrair imagens

Extrai imagens/fotos da tela.

Detecta regiões de imagem/foto com bounds e metadados. Extração especializada; a árvore DOM (US-13) já cobre imagens na fase “restante”.
