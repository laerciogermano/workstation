...
Com serial online e path de saída, captura o frame atual e grava o arquivo de imagem. O print alimenta visão (US-12), OCR/extração (US-13..17) e evidência de aceite.
...
Compõe a árvore de componentes da tela (estilo DOM).

**Primeiro** extrai **apenas textos** e devolve a árvore só com textos; **em seguida** extrai o restante (ícones, listas, imagens) e devolve a árvore completa. Saída de cada fase: árvore de componentes com os elementos respectivos. US-14..17 são extrações especializadas opcionais (cada uma também devolve árvore com o tipo respectivo).

### US-14 — Extrair ícones

Extrai ícones e devolve a árvore de componentes contendo os ícones.

A partir de imagem/frame ou dump, reconhece ícones (bounds, metadados) e monta a árvore só com esses elementos.

### US-15 — Extrair textos

Extrai textos (OCR) e devolve a árvore de componentes contendo os textos.

A partir de imagem/frame, reconhece strings e bounds e monta a árvore só com esses elementos.

### US-16 — Extrair listas

Extrai listas e devolve a árvore de componentes contendo as listas (com itens filhos).

Identifica nós de lista e itens na tela/dump e monta a árvore só com esses elementos.

### US-17 — Extrair imagens

Extrai imagens/fotos e devolve a árvore de componentes contendo as imagens.

Detecta regiões de imagem/foto (bounds, metadados) e monta a árvore só com esses elementos.
