...
Com serial online e path de saída, captura o frame atual e grava o arquivo de imagem. O print alimenta visão (US-12), OCR/extração (US-13..16) e evidência de aceite.
...
Compõe a árvore de componentes da tela (estilo DOM) e **extrai textos** na fase 1.

**Primeiro** extrai **textos** e devolve a árvore só com textos; **em seguida** extrai o restante (ícones, listas, imagens) e devolve a árvore completa. Saída de cada fase: árvore de componentes com os elementos respectivos. US-14..16 são extrações especializadas opcionais (ícones, listas, imagens).
