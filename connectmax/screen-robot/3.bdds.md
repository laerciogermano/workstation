...
Cenário: US-13 Árvore de componentes é composta em duas fases
  ...
  Quando primeiro apenas textos são extraídos e montados na árvore
...
Cenário: SC-17 Árvore de componentes com textos (fase 1)
  Dado uma imagem da tela (screenshot/frame) ou dump
  Quando a fase 1 extrai apenas textos e monta a árvore
...
```gherkin
Cenário: US-15 Árvore de componentes com textos
  Dado uma imagem da tela (screenshot/frame)
  Quando o OCR monta a árvore de textos
  Então a árvore de componentes contendo os textos é devolvida
```
...
```gherkin
Cenário: SC-20 Árvore de componentes com textos
  Dado uma imagem da tela (screenshot/frame)
  Quando o OCR monta a árvore de textos
  Então a árvore de componentes contendo os textos é devolvida
```
...
```gherkin
Cenário: US-16 Árvore de componentes com listas
  Dado uma imagem da tela (screenshot/frame) ou dump
...
```gherkin
Cenário: SC-21 Árvore de componentes com listas
  Dado uma imagem da tela (screenshot/frame) ou dump
  Quando o reconhecimento de listas monta a árvore
  Então a árvore de componentes contendo as listas é devolvida
```
...
```gherkin
Cenário: US-17 Árvore de componentes com imagens
  Dado uma imagem da tela (screenshot/frame) ou dump
...
```gherkin
Cenário: SC-22 Árvore de componentes com imagens
  Dado uma imagem da tela (screenshot/frame) ou dump
  Quando o reconhecimento de imagens/fotos monta a árvore
  Então a árvore de componentes contendo as imagens é devolvida
```
