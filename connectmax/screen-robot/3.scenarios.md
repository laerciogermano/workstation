...
**Por quê:** US e cenários (SC) do robô, todos expostos via **código Node**. BDDs: [`4.bdds.md`](4.bdds.md).  
...
**IDs:** **US-** = história (título da seção) · **SC-XX** = cenário sequencial (toda US tem ≥1 SC).
...
| Artefato | Caminho |
|----------|---------|
| BDDs (unitário + piloto LinkedIn) | [`4.bdds.md`](4.bdds.md) |
| Script | [`sources/android-control/scripts/linkedin-login.js`](sources/android-control/scripts/linkedin-login.js) |

## Próximos passos

→ [`4.bdds.md`](4.bdds.md) · [`5.implementation-plan.md`](5.implementation-plan.md) · [`7.tasks.md`](7.tasks.md) · [`core/tasks`](../../core/tasks/README.md#p1--connectmax--screen-robot)  
