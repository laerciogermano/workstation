...
**Por quê:** aceite Gherkin de cada **US** e de cada **SC** (fonte: [`3.scenarios/`](3.scenarios/README.md)).  
...
→ [`implementation-plan/`](implementation-plan/README.md) · [`6.roadmap.md`](6.roadmap.md)
