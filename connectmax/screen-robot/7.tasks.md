...
| TSK-021 | Extrair elementos | Agrupa árvore DOM (textos → restante) e extrações tipadas | Árvore de componentes por tipo / completa | Todo | | | 100 min |
| TSK-022 | Extrair textos (fase 1) | Fase 1 da árvore DOM: extrai textos e monta árvore | Árvore de componentes contendo os textos | Todo | | | 20 min |
