...
**IDs:** **US-** = história (uma ação/capacidade). **SC-** = cenário sob US-01, US-02 e US-20.  
...
| US-10 | key | Enviar keyevent | 15 |
| US-11 | scroll | Swipe / scroll na tela ou lista | 15 |
| US-12 | screenshot | Capturar frame da tela | 15 |
| US-13 | Resgatar coordenadas x,y | Localizar alvo na tela a partir de imagem de entrada | 15 |
| US-14 | Extrair nó Texto | Textos com string e bounds | 20 |
| US-15 | Extrair nó Ícone | Pictogramas/controles com tipo e bounds | 20 |
| US-16 | Extrair nó Imagem / foto | Regiões de mídia com bounds | 24 |
| US-17 | Extrair nó Lista | Coleção rolável com itens filhos e scroll | 24 |
| US-18 | Extrair nó Container | Card/toolbar/painel com filhos | 12 |
| US-19 | Montar árvore DOM | Compor hierarquia raiz → filhos (estilo DOM) | 20 |
| US-20 | Guardar estado de sessão | Persistir e restaurar contexto da sessão | 30 |
