...
| US-02 | Validar captura no redroid | Smoke que comprova frame PNG real no device online | Evita avançar Perceive/Actuate com captura quebrada ou device offline | 9m | [`US-02-validar-captura-no-redroid/`](US-02-validar-captura-no-redroid/README.md) |
| US-03 | Capturar tela via agent | Capturar a tela por agent no hardware com o mesmo Frame da US-01 | No hardware o screencap ADB pode não bastar; o agent mantém o mesmo contrato | 90m | [`US-03-capturar-tela-via-agent/`](US-03-capturar-tela-via-agent/README.md) |
| US-04 | Escolher backend de captura | Selecionar `adb` ou `agent` por config/factory | Trocar redroid ↔ hardware sem reescrever Perceive/Decide | 24m | [`US-04-escolher-backend-de-captura/`](US-04-escolher-backend-de-captura/README.md) |
