...
1. Todo prompt novo: gravar em [`../../prompts/NNN-…`](../../prompts/) + linha na timeline.
2. Cascata da esteira de vendas até `prototype.html` quando o artefato for pedido/criado.
3. Ações de UI no LinkedIn: depender do [`../../screen-robot/`](../../screen-robot/), não reimplementar perceive/actuate aqui.
