...
Fluxo de desenvolvimento (IA): clone **na pasta `task-<nn>-<titulo>` em `tasks/`** → branch homônima → TDD → implementar → testar → PR → **Pendente aprovação** → **humano valida** → próximo robô. Ordem = Gantt das tasks; sequencial espera, paralelo pode subir PRs separados. Detalhe: [`processo/3.desenvolvimento`](../processo/3.desenvolvimento/README.md).
...
**Gantt:** [`screen-robot/7.tasks.md`](../../connectmax/screen-robot/7.tasks.md) · **Roadmap:** [`3.roadmap.md`](../../connectmax/screen-robot/3.roadmap.md).
Épicos/US: [`2.epics.md`](../../connectmax/screen-robot/2.epics.md) · scenarios/BDDs: [`4.scenarios.md`](../../connectmax/screen-robot/4.scenarios.md) / [`5.bdds.md`](../../connectmax/screen-robot/5.bdds.md).
...
1 dia útil = 8h. Entradas/Execução/Saídas: [`4.scenarios.md`](../../connectmax/screen-robot/4.scenarios.md).
...
| SC-19 | Extrair ícones | 2026-09-19 | 2026-09-19 | Árvore de componentes contendo os ícones |
| US-15 | Extrair listas | 2026-09-19 | 2026-09-19 | Árvore de componentes contendo as listas |
| SC-20 | Extrair listas | 2026-09-19 | 2026-09-19 | Árvore de componentes contendo as listas |
| US-16 | Extrair imagens | 2026-09-19 | 2026-09-19 | Árvore de componentes contendo as imagens |
| SC-21 | Extrair imagens | 2026-09-19 | 2026-09-19 | Árvore de componentes contendo as imagens |
| US-17 | Salvar sessão | 2026-09-19 | 2026-09-19 | Arquivo de sessão |
| SC-22 | Salvar sessão | 2026-09-19 | 2026-09-19 | Arquivo de sessão |
| US-18 | Remover sessão | 2026-09-19 | 2026-09-19 | Sessão removida |
...
| Todo | Doing | Done |
|------|-------|------|
| [Login LinkedIn (BDD)](../../connectmax/screen-robot/5.bdds.md) · `npm run linkedin-login` | | [Libs Node 6 recortes](../../connectmax/screen-robot/sources/android-control/README.md) |

→ [`screen-robot/`](../../connectmax/screen-robot/README.md) · [`5.bdds.md`](../../connectmax/screen-robot/5.bdds.md)
