...
1 dia útil = 8h. Entradas/Execução/Saídas: [`functionalities.md`](../../connectmax/screen-robot/docs/functionalities.md).
...
→ [`screen-robot/`](../../connectmax/screen-robot/README.md) · [`functionalities.md`](../../connectmax/screen-robot/docs/functionalities.md)
