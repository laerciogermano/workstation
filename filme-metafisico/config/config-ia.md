# Configurações para a IA — O Metafísico (filme)
...
4. Repetir até chegar ao **último nó** da árvore (`roteiro.md`).
...
| 2 | `tese.md` | `sinopse.md` |
| 3 | `sinopse.md` | `estrutura.md` |
| 4 | `estrutura.md` | `roteiro.md` |
| 5 | `roteiro.md` | *(fim da árvore)* |
