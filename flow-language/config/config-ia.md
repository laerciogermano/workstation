# Configurações para a IA — Flow Language
...
### Dependência com o Flow

Este projeto **precede** o [`flow/`](../../flow/). Ao alterar o modelo de linguagem, IR ou visualização aqui, alinhar referências no Flow (e, se afetar FOP no Gantt, no Plans) — sem deixar o consumidor redefinir a linguagem.
