...
**Por quê:** garantir que alterações na documentação propaguem até o fim da esteira.  
**Importante:** evita entregas pela metade (ex.: história sem BDD, tela sem componentes, componentes sem protótipo).  
...
| 4 | [`../docs/screens.md`](../docs/screens.md) | [`../docs/screens-bdd.md`](../docs/screens-bdd.md) |
| 5 | [`../docs/screens-bdd.md`](../docs/screens-bdd.md) | [`../docs/components.md`](../docs/components.md) |
| 6 | [`../docs/components.md`](../docs/components.md) | [`../docs/prototype.html`](../docs/prototype.html) |
| 7 | [`../docs/prototype.html`](../docs/prototype.html) | *(fim da árvore)* |
