...
| E02 | Descoberta e ciclo de vida do evento |
| E03 | Ingressos e pagamento |
| E04 | Cardápio digital e consumação |
...
| E10 | Painel do parceiro (bares e casas) |
...
![Capa do épico E02 — Descoberta e ciclo de vida do evento](assets/epic-e02-cover.png)

O usuário encontra o que está rolando perto dele por geolocalização e raio configurável (ex.: 5, 20 ou 50 km), com modos Feed, Tinder (swipe), Lista e Mapa (conforme premium/patrocínio), filtros por tipo e dia, destaque de eventos patrocinados e radar dinâmico com cards atualizados. Cada evento tem página completa (local, horários, valores de entrada/VIP/bebida, confirmados, interessados, influenciadores contratados e fotos de edições anteriores) e ciclo do anúncio ao pós-evento (cadastro e edição por anfitriões e casas, avaliação, comentário e selos) — unificando a descoberta espalhada hoje em Instagram, Google, sites e WhatsApp e dando informação suficiente para decidir, comprar e lembrar o rolê.

## E03 — Ingressos e pagamento

![Capa do épico E03 — Ingressos e pagamento](assets/epic-e03-cover.png)
...
![Capa do épico E04 — Cardápio digital e consumação](assets/epic-e04-cover.png)
...
2. **E02** Descoberta e ciclo de vida do evento  
3. **E03** Ingressos  
4. **E09** Notificações  
5. **E05** Gamificação básica + pós-evento  
