...
| ID | Cenário | Entradas | Execução | Saídas |
|----|---------|----------|----------|--------|
| SC-25 | Localizar agent pelo nome | Nome de agent já provisionado | Resolver container/runtime e serial associados ao nome | Referência ao runtime existente (ou erro tipado se ausente) |
