...
**Piloto:** [`src/scripts/linkedin-login.js`](src/scripts/linkedin-login.js) — limpa screenshots → `resetInstance` → provision → LinkedIn → print tela inicial → lista OCR no console (sem digitar credenciais / sem `saveSession`).
...
**US:** US-13..16 · US-23 · **SC:** SC-17..21 · SC-29 · **Cenários:** [`4.scenarios.md#ep-05--extrair-elementos`](4.scenarios.md#ep-05--extrair-elementos) · **Plano:** [`implementation-plan/EP-05-extrair-elementos.md`](implementation-plan/EP-05-extrair-elementos.md)
