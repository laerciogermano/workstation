...
## EP-05 — Extrair textos

**US:** US-13 · US-23 · **SC:** SC-17 · SC-29..30 · **Cenários:** [`4.scenarios.md#ep-05--extrair-textos`](4.scenarios.md#ep-05--extrair-textos) · **Plano:** [`implementation-plan/EP-05-extrair-elementos.md`](implementation-plan/EP-05-extrair-elementos.md)

### US-13 — Extrair textos

```gherkin
Cenário: US-13 Lista plana só com textos OCR
  Dado uma imagem/frame da tela (screenshot ADB, stream ou câmera)
  Quando extract({ serial }) roda OCR sobre o frame
