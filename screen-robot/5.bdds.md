...
Cenário: US-23 Busca por texto encontra elemento ou conjunto com score elevado
  Dado uma lista de elementos OCR (ex. "Sign", "in", "with", "Email" separados)
  E um texto-alvo "Sign in with Email"
  Quando a busca por similaridade é executada
  Então devolve um elemento ou um conjunto de elementos vizinhos
...
Cenário: SC-29 Match por texto unido ou parcial com score
  Dado a lista OCR e o texto-alvo
  Quando findByText (ou equivalente) ranqueia matches
