...
gantt
  ...
  section TSK-021 EP-05 Extrair textos
  TSK-021 EP-05 Extrair textos          :done, tsk21, after tsk09, 60m
  TSK-022 US-13 Extrair textos OCR      :tsk22, after tsk09, 40m
  TSK-023 SC-17 Extrair textos          :tsk23, after tsk22, 20m
...
| TSK-021 | Extrair textos | Pipeline frame → OCR → lista plana de textos (US-13) | Lista `type: "text"` | Done | | | 60 min |
| TSK-022 | Extrair textos (OCR) | Frame → OCR textos + bounds → lista (US-13) | Lista só de textos | Done | | | 40 min |
| TSK-023 | Extrair textos (SC-17) | OCR no frame: textos + bounds → `extract({ serial })` | Lista com elementos `text` | Done | | | 20 min |
| TSK-037 | Buscar por texto (similaridade) | `findByText`: lado a lado + contidos na query; SC-30 LinkedIn (US-23) | `{ elements, score }` · Sign+in+with+Email | Done | | | 30 min |
