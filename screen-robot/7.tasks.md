...
| TSK-021 | Extrair elementos | Pipeline frame → OCR/visão → árvore DOM (sem dump uiautomator) | Árvore de componentes por tipo / completa | Done | | | 100 min |
| TSK-022 | Extrair árvore DOM com textos | Frame → OCR textos + visão restante até árvore completa | Árvore de componentes completa | Done | | | 40 min |
| TSK-023 | Extrair textos (fase 1) | OCR no frame: textos + bounds → árvore | Árvore de componentes contendo os textos | Done | | | 20 min |
| TSK-024 | Extrair restante e compor árvore DOM | Visão + OCR: ícones/listas/imagens; completa a hierarquia | Árvore de componentes completa | Done | | | 20 min |
| TSK-025 | Extrair ícones | Visão reconhece ícones no frame e monta árvore | Árvore de componentes contendo os ícones | Done | | | 20 min |
| TSK-026 | Extrair listas | Visão + OCR extrai listas/itens no frame e monta árvore | Árvore de componentes contendo as listas | Done | | | 20 min |
| TSK-027 | Extrair imagens | Visão detecta regiões de imagem/foto no frame e monta árvore | Árvore de componentes contendo as imagens | Done | | | 20 min |
